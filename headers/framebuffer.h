...
public:
    ...
    //画面のクリア
    void Clear(ID3D11DeviceContext* immediate_context, usage flags = usage::color_depth_stencil, DirectX::XMFLOAT4 color = { 0.2f, 0.2f, 0.2f, 1.f }, float depth = 1, uint8_t stencil = 0);
    //レンダリング開始
